...
module Doorkeeper
  module OpenidConnect
  	module Ciba
	    ...
	    class GetauthinfoController < CommonController
			before_action :validate_auth_client, only: [:getauthinfo]
	    #
	    ...
	    def getauthinfo
			render Doorkeeper::OpenidConnect::Ciba::GetAuthInfo.new(params, server).getauthinfo
	    end
	  end
	end
  end
